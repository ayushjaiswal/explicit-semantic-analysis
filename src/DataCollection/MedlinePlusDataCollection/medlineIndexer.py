...
topicFiles = [fileName for fileName in listdir(topicPath) if isfile(topicPath+fileName) and fileName[:-1] != '~']
articleFiles = [fileName for fileName in listdir(articlePath) if isfile(articlePath+fileName) and fileName[:-1] != '~']
